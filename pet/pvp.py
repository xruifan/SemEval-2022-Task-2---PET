...
class MyTaskPVP(PVP):
    ...
    def get_parts(self, example: InputExample):
        ...
        mwe = example.meta['mwe']
        mwe_second_word = example.meta['mwe_second_word']
        ...
        if self.pattern_id == 0:
            ...
            # this corresponds to the pattern a. mwe is [MASK] literal.
            return [text_a, '. ' , mwe , ' is ', self.mask, ' literal.'], []
        
        elif self.pattern_id == 3:
            # this corresponds to the pattern a. [MASK] mwe is literal.
            return [text_a, '. ' , self.mask, ' ', mwe, ' is literal.'], []
    ...
    def verbalize(self, label) -> List[str]:
        if self.pattern_id == 2:
            return MyTaskPVP.VERBALIZER_P2[label]
        elif self.pattern_id == 3:
...
PVPS = {
    ...
    'ax-b': RtePVP,
    'ax-g': RtePVP,
    'idiom-detection': MyTaskPVP,           # added custom task PVP      --Xuan-Rui Fan
}
